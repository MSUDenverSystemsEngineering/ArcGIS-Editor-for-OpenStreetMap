...
Try {
	...
	[string]$appName = 'ArcGID Editor for OpenStreetMap'
	[string]$appVersion = '10.3.0.13'
	[string]$appArch = 'x86'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '02/06/2017'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		## Show Welcome Message, close ArcMap, verify there is enough disk space to complete the install, and persist the prompt
		Show-InstallationWelcome -CloseApps 'arcmap' -CheckDiskSpace -PersistPrompt
		...
		Execute-Process -Path "setup.exe" -Parameters "/s /v`"/qn`"" -WindowStyle 'Hidden' -PassThru
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		## Show Welcome Message, close ArcMap with a 60 second countdown before automatically closing
		Show-InstallationWelcome -CloseApps 'arcmap' -CloseAppsCountdown 60
		...
		Execute-MSI -Action "Uninstall" -Path "{3B46855B-DCBA-44A1-ADB3-CC7C5D43F42D}" -PassThru
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBbLzvAHVMbhtOh
# +8xUAGhsubIBm7JDSwbEh9ARoiQO06CCD4cwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# gAAwGQYJKoZIhvcNAQkDMQwGCisGAQQBgjcCAQQwLwYJKoZIhvcNAQkEMSIEICs+
# UVaU5Id6neW4lFw58VBOu7wk/l+fiQUhxXso6AVlMA0GCSqGSIb3DQEBAQUABIIB
# ADIWdiCZhNJLSXQcskqIjVoGi3hVB/xG+Apss8qXVdj4tFL2Q/FssrQKJfXUY3h5
# AxC90RaZwmVe3xGOlO/rEPXdf45a9zXO2A+jT32HikXNw+lnjOOV6sVfA3t2ECFM
# ILuci7zl6IhnJOYXMUYe75qICJgPhR8uBv4dRd9GlUFtXVdA3ebNmi0FqxIBTZvL
# cWvOvPjt6cq9o5++748Sl2K8V4RKHWnWY2sMrxFIlrRiPA0YkYxKnt1xymtBOePr
# pZ/RG/gEIJ2E9JVfQBEGOpRnwp8FEv4PGrKYU0B8Zez+YZCyUojv5sGGZGJv8vj/
# Eilbgip5BZcRJ2NNc5r1Gf6hggKiMIICngYJKoZIhvcNAQkGMYICjzCCAosCAQEw
...
# ATAcBgkqhkiG9w0BCQUxDxcNMTcwMjA2MjM0ODA3WjAjBgkqhkiG9w0BCQQxFgQU
# gfONlXzBiuxe1fscNzgTxOjMf6UwgZ0GCyqGSIb3DQEJEAIMMYGNMIGKMIGHMIGE
...
# AQUABIIBAIeK3d9npS0I0lYkdAukrbFySuHZNLZLdoeBQpaJ0pY3EXRTEwHOQnzU
# Fr6fD6qYGnqhIMUQMIYaO2OUTSUeJ5QiUH2IPlxRaAjxHomrJU2chMrpEFJUNW89
# +tvpycKhX3arDcRAAE3DlZaGfiDNkxjtpUePzKogNTjY0AwSs5S9WHmVRYH9b2je
# EGomu7ZNB7n3hTB8s+/+JTLJWEvljCK0wMHm7xOBueEHCTa0rCiJRERIsyFV+k+K
# 8vUuUjHgh2JZFucVxaEvtBAm2JCUSCa23VYoBF5CmUjQNU8Xc22GTzNeB7a/A7/T
# gvCS81YV6lPWBvKW7avmzHqL1v3lE1c=
